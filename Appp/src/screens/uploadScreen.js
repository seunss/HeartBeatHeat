    ...
    async _stopRecordingAndEnablePlayback() {
        ...
        async function uploadAudioAsync(uri) {
           // console.log("Uploading " + uri);
            let apiUrl = 'http://heartbeatheat.herokuapp.com/coleworld';
            ...
            const response = await fetch("http://heartbeatheat.herokuapp.com/coleworld", {
                method: 'POST',
                body: formData,
                headers: {
                    'Accept': 'application/json',
            ...
            //return fetch(apiUrl, options).then(function (response) { console.log(response.json()) })
        }
      ...
      //console.log(`FILE INFO: ${JSON.stringify(info)}`);
        ...
        //const htmlAudioElement = document.getElementById("info");
